function [newD, C, lat, explained, params] = reducedims_EH(D,alg, dims, handles)
...
%     end
    ...
    switch alg
        ...
        case 2
            [newD C lat explained] = PPCAreduce(D,dims);
        case 3
            [newD C lat explained] = FAreduce(D,dims);
        case 4
            [newD C explained] = LDAreduce(D,dims);
        case 5
            handles.binWidth = 2;
...
function [newD C lat explained] = PPCAreduce(D,dims)
...
function [newD C lat explained] = FAreduce(D,dims)
